...
# Default Pick Pose ('zed_camera')
pick_pose = PoseStamped()
pick_pose.header.frame_id = 'zed_camera'
...
old_ur5_scan_fac_pose = {'ra_elbow_joint': 1.0483, 
                     'ra_shoulder_lift_joint': -1.7474, 
                     'ra_shoulder_pan_joint': -0.7863, 
                     'ra_wrist_1_joint': -1.1333, 
                     'ra_wrist_2_joint': -1.5713, 
                     'ra_wrist_3_joint': 0.0000}

ur5_scan_fac_pose = {'ra_elbow_joint': 2.1817, 
                     'ra_shoulder_lift_joint': -2.6180, 
                     'ra_shoulder_pan_joint': -0.7854, 
                     'ra_wrist_1_joint': -1.9199, 
                     'ra_wrist_2_joint': -1.5707, 
                     'ra_wrist_3_joint': 0.0000}

# UR5 Scan Conveyor Pose
ur5_scan_pose = {'ra_elbow_joint': 0.6245, 
                 'ra_shoulder_lift_joint': -1.3098, 
                 'ra_shoulder_pan_joint': -0.0772, 
                 'ra_wrist_1_joint': -1.1556, 
                 'ra_wrist_2_joint': -1.8180, 
                 'ra_wrist_3_joint': 0.6365}
...
if __name__ == "__main__":
    ...
    # Init ROS
    rospy.init_node('pick_n_place_zed')
    ...
    # Create ZED camera frame
    tf_broadcaster.sendTransform((0.06096107, 0.08691441, 0.12981221),                   # translation
                                 (-0.00137736, 0.01551703, 0.99987669, -0.00198366),     # rotation
                                 rospy.Time.now(),
                                 '/zed_camera',  # child frame
    ...
    place_pose.pose.position.x = factory_pos.pose.position.x + 0.0370
    place_pose.pose.position.y = factory_pos.pose.position.y + 0.0300
    place_pose.pose.position.z = factory_pos.pose.position.z + 0.1700
